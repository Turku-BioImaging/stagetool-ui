<template>
  <footer class="default-footer">
    <div class="container mx-auto w-2/3">
      ...
      <div class="devs-list">
        <h3 class="footer-subtitle">Developers</h3>
        <ul>
      ...
      <div class="org-list">
        <h3 class="footer-subtitle">Organizations</h3>
        <div class="org-item">
        ...
        <div class="org-item">
          <img class="utu-logo" src="@/assets/logos/UTU_logo_EN_RGB.png" alt="" />
          <p>
            Institute of Biomedicine<br />Integrative Physiology and Pharmacology Unit<br />University
        ...
        <div class="org-item">
          ...
          <p>
            A broad-based interdisciplinary science and infrastructure umbrella jointly operated by
            Åbo Akademi University and the University of Turku.<br />Turku, Finland
          </p>
        </div>
      </div>
    </div>
...
footer.default-footer {
  ...
  > div {
    @screen lg {
      @apply grid grid-cols-3 gap-8 w-2/3 mx-auto;
    }
  }
